...
const Faqs = () => {
  ...
  return (
    <div className="py-[3rem]">
      <h2 className="md:text-[56px] text-[30px] font-semibold text-[#15BFFD] text-center my-[2rem]">
        FAQS
      </h2>
          ...
          return (
            ...
            >
              <div className=" flex justify-between items-center">
                <h2
                  className="md:text-[16px] text-[10px] shadow-2xl  font-semibold flex md:gap-[2rem] gap-[1rem] md:px-4 px-2 items-center  "
                  
                >
                  <span>0{index + 1}</span> {items.heading}
                </h2>
                <p className=" bg-[#152329] w-[86px] md:h-[80px]  h-[60px] flex items-center justify-center md:text-[25px] text-[18px] hover:bg-[#15BFFD] transition-all ease-linear delay-150 " onClick={() => handlePopUp(index)}>
                  <FaPlus />
                </p>
              </div>
              {open === index && (
